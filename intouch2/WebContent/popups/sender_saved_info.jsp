<%@ page contentType="text/html; charset=UTF-8" %>
 ...
 <div id="senderSavedInfo" class="roundedcornr_box_171934" style="display:none;width: 260px;overflow: visible;z-index: 6001;position: absolute;">
